  ...
  $(function() {
    if (typeof FileReader === 'undefined') {
      ...
      $('#file-input').change(function() {
        var file, files, li, noun, reader, _i, _len, _results;
        ...
        if (files.length > 0) {
          ...
          for (_i = 0, _len = files.length; _i < _len; _i++) {
            ...
            _results.push(/^text\//.test(file.type) ? (li.append("<span class=\"header\">Text</span>"), reader = new FileReader(), reader.onerror = (function(li, file) {
              return function(event) {
                return li.append("<span class=\"error\">Error: " + FILE_ERROR_NAMES[reader.error.code] + "</span>");
              };
            })(li, file), reader.onloadstart = (function(li, file) {
              return function(event) {
                return li.append("<span>Load Start!</span>");
              };
            })(li, file), reader.onprogress = (function(li, file) {
              return function(event) {
                return li.append("<span>Progress: " + (reader.readyState === reader.LOADING ? 'loading' : 'done') + "</span>");
              };
            })(li, file), reader.onloadend = (function(li, file) {
              return function(event) {
                li.append("<span>Load End!</span>");
                if (event.target.readyState === event.target.DONE) {
                  return li.append("<pre class=\"data\">" + event.target.result + "</pre>");
                }
              };
            })(li, file), reader.readAsText(file)) : void 0);
          }
          return _results;
        }
      });
